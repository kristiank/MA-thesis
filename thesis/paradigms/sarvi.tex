...
\vspace{1em}
\noindent Tüüpsõna hõlmab vormisõnastikus 10 lekseemi: \vadja{\underline{sarv}i, \underline{sav}i, \underline{Soom}i, \underline{sõrm}i, \underline{taim}i, \underline{talv}i, \underline{tamm}i, \underline{õnn}i, \underline{õvv}i} ja \vadja{\underline{põlv}i}.
