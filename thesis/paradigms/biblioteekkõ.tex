...
\vspace{1em}
\noindent Tüüpsõna hõlmab vormisõnastikus 10 lekseemi: \vadja{\underline{biblioteek}kõ, \underline{hoik}kõ, \underline{ikolook}kõ, \underline{jaanikuk}kõ, \underline{kolk}kõ, \underline{kon̕jõk}kõ, \underline{kuk}kõ, \underline{rok}kõ, \underline{suk}kõ} ja \vadja{\underline{bambuk}kõ}.
