...
\vspace{1em}
\noindent Tüüpsõna hõlmab vormisõnastikus 6 lekseemi: \vadja{\underline{inostrant}t\underline{s}õ, \underline{liit}t\underline{s}õ, \underline{tablit}t\underline{s}õ, \underline{vat}t\underline{s}õ, \underline{õt}t\underline{s}õ} ja \vadja{\underline{bol̕nit}t\underline{s}õ}.
