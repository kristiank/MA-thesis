...
\vspace{1em}
\noindent Tüüpsõna hõlmab vormisõnastikus 10 lekseemi: \vadja{\underline{ai}kõ, \underline{jal}kõ, \underline{lii}kõ, \underline{lõn}kõ, \underline{nah}kõ, \underline{rah}kõ, \underline{vil}kõ, \underline{vin}kõ, \underline{võl}kõ} ja \vadja{\underline{aastai}kõ}.
