...
\vspace{1em}
\noindent Tüüpsõna hõlmab vormisõnastikus 9 lekseemi: \vadja{\underline{iir}i, \underline{meel}i, \underline{mer}i, \underline{peen}i, \underline{sül}i, \underline{ver}i, \underline{ään}i, \underline{äär}i} ja \vadja{\underline{čeel}i}.
