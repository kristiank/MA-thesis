...
\vspace{1em}
\noindent Tüüpsõna hõlmab vormisõnastikus 28 lekseemi: \vadja{\underline{bukv}õ, \underline{duum}õ, \underline{form}õ, \underline{ilm}õ, \underline{koir}õ, \underline{konn}õ, \underline{kuhj}õ, \underline{kuiv}õ, \underline{kumm}õ, \underline{kuuluv}õ, \underline{kõrv}õ, \underline{mood}õ, \underline{muudr}õ, \underline{mõiz}õ, \underline{obraaz}õ, \underline{post}õ, \underline{programm}õ, \underline{rooj}õ, \underline{sool}õ, \underline{sveež}õ, \underline{trubačist}õ, \underline{tuim}õ, \underline{tuttav}õ, \underline{velosiped}õ, \underline{vohm}õ, \underline{vool}õ, \underline{võim}õ} ja \vadja{\underline{bomb}õ}.
