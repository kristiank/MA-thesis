...
\vspace{1em}
\noindent Tüüpsõna hõlmab vormisõnastikus 5 lekseemi: \vadja{\underline{moodno}i, \underline{portno}i, \underline{požarno}i, \underline{prosto}i} ja \vadja{\underline{bodro}i}.
