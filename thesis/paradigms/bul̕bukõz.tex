...
\vspace{1em}
\noindent Tüüpsõna hõlmab vormisõnastikus 8 lekseemi: \vadja{\underline{bul̕buk}õz, \underline{čirk}õz, \underline{liivõk}õz, \underline{mansik}õz, \underline{musik}õz, \underline{nenäk}õz, \underline{õnnõk}õz} ja \vadja{\underline{baabuk}õz}.
