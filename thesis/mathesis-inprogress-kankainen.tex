...
\paragraph*{Illatiiv}
Loodava kirjakeele ühtlustamise huvides on vormisõnastiku koostamisel eelistatud läbinähtava käändelõpuga vormi \textit{-se/-sõ} lühikese illatiivi asemel. Selline eelistus on mõnevõrra vastu\-olus olukorraga tänapäeva Luuditsa murdes, kus Markuse ja Rozhanskiy (\citeyear[247]{markus_comitative_2014}) järgi esineb tavaliselt lühike vorm ja pikk vorm esineb väga harva. Heinsoo ja Konkova õppe\-materjalides on mõlemad vormid esitatud rööpselt (\cites[88]{heinsoo_vadsonakopittoja_2015}[10]{konkova_vaddceeli_2014}).
