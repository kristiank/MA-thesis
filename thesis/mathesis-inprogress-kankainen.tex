...
Morfoloogialabori rakendus kasutab ekstraktmorfoloogia meetodit (mida tutvustatakse peatükis~\ref{sec:ekstraktmorfoloogia}) ja lihtsustab uute sõnade lisamist vormisõnastikku. Rakendus ennustab sisestatud sõnale sobivaid tüüpsõnu ja moodustab tüüpsõnale vastavalt kõik muutvormid. Kasutaja peab kontrollima, kas muutvormid on õiged või valima teise muuttüübi.  Rakendus on ühendatud korpuspäringute süsteemiga KORP ja näitab muutvormi juures kasutajale selle esinemis\-arvu korpustes.

% TODO siia lisada ekraanitõmmis!
