...
Matthews tõstab esile kaks paradidmaatilise morfoloogia käsitlust, klassikaline ja uus ehk strukturalistlik.
...
See osa kirjeldab ekstraktmorfoloogiaga leitud vadja keele morfoloogilised sõnatüübid ja jaotab need käändkondadesse. Käändkondade süsteemiks on kasutatud Ariste (\citeyear{ariste_grammar_1968}) grammatikas esitatud.
...
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega rč:rj.
\input{paradigms/koffi}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega ff:f, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
\input{paradigms/suuto}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega t:∅. % TODO kuidas 0 ?
\input{paradigms/vahti}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega t:∅, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
...
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega kk:k, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
...
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega kk:k, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
\input{paradigms/põlto}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega lt:ll.
\input{paradigms/greebeni}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
...
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
\input{paradigms/poštaljon}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu.
\input{paradigms/sünti}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega nt:nn, mille lõpuvokaal on \textit{i}.
...
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega pp:p, mille lõpuvokaal on \textit{i}.% TODO i tüvi?
...
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega pp:p, mille lõpuvokaal on \textit{i}.% TODO i tüvi?
...
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega s:z, mille tüvi konsonant\-klustri tõttu ei gemineeru, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
\input{paradigms/rusko}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega sk:zg.
\input{paradigms/rissi}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega ss:s, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
\input{paradigms/passi}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega ss:s, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
\input{paradigms/karjušši}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega šš:š, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
\input{paradigms/täti}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega t:d, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
\input{paradigms/kotko}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega tk:dg.
\input{paradigms/kittsi}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega tt:t, mille lõpuvokaal on \textit{i}. % TODO i tüvi?
...
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega tt:t, mille lõpuvokaal on \textit{i}.  % TODO i tüvi?
...
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega fk:vg. 
\input{paradigms/mahsõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega hs:hz.
\input{paradigms/vihtõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega ht:h.
\input{paradigms/aitõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega it:jj.
\input{paradigms/aikõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega k:g.
\input{paradigms/sika}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega k:g, mis geminaadi tõttu esinevad \msd{sg ill} vormis tugevas astmes.
\input{paradigms/borovikkõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega kk:k.
\input{paradigms/siltõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega lt:ll.
\input{paradigms/paha}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{a} ning mis on \msd{sg par} ja \msd{sg ill} vormis tugevas astmes.
\input{paradigms/baldõhina}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{a}.
\input{paradigms/az̕z̕õ}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{õ}.
\input{paradigms/bank}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, millel puudub lõpuvokaal.
\input{paradigms/pintõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega nt:nn.
\input{paradigms/rapa}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega p:v, mille lõpuvokaal on \textit{a}.
\input{paradigms/aapõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega p:v, mille lõpuvokaal on \textit{õ}.
\input{paradigms/liippõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega pp:p.
\input{paradigms/partõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega rt:rr.
\input{paradigms/kraaskõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega sk:zg.
\input{paradigms/klaassõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega ss:s.
\input{paradigms/poduškõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega šk:žg.
\input{paradigms/dovariššõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega šš:š.
\input{paradigms/sata}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega t:∅.
\input{paradigms/l̕iitkõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega tk:dg.
\input{paradigms/kand̕idaattõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega tt:t.
\input{paradigms/inostranttsõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega tts:ts.
\input{paradigms/jõutu}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega ut:vv, mille lõpuvokaal on \textit{u}.
\input{paradigms/poutõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega ut:vv, mille lõpuvokaal on \textit{õ}.
\input{paradigms/štanad}
Sõnatüübi\-mall kirjeldab tagapoolset tüvemuutuseta \textit{plurale tantum} sõna.
\spacing{1.5}
...
Sõnatüübi\-mall kirjeldab tagapoolset tüvemuutuseta sõna.
\input{paradigms/poikõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega k:g.
\input{paradigms/biblioteekkõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega kk:k.
\input{paradigms/kõik}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega kk:k, millel puudub lõpuvokaal.
\input{paradigms/kultõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega lt:ll.
\input{paradigms/vimpõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega mp:mm.
\input{paradigms/kompjutera}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{a}.
\input{paradigms/maamuna}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille mitmuse tüvi on -\textit{õi}-.
\input{paradigms/mokom}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, millel puudub lõpuvokaal.
\input{paradigms/bukvõ}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{õ}.
\input{paradigms/propkõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega pk:bg.
\input{paradigms/rooppõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega pp:p.
\input{paradigms/kurp}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega rp:rv.
\input{paradigms/usa}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega s:z, mille lõpuvokaal on \textit{a}.
\input{paradigms/õhsõ}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega s:z, mille lõpuvokaal on \textit{õ}.
...
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega t:vv.
...
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega č:∅.
...
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega nč:n̕n̕.
\input{paradigms/siipi}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega p:v.
\input{paradigms/kuusi}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega s:z.
\input{paradigms/tauti}
Sõnatüübi\-mall kirjeldab tagapoolseid sõnu tüvemuutusega t:d.
\spacing{1.5}
...
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega lč:ll.
\input{paradigms/eine}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{e} ja mitmuse tüvi on -\textit{ii}-.
\input{paradigms/läkine}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{e} ja mitmuse tüvi on -\textit{ei}-.
\input{paradigms/räpäle}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{e} ja mitmuse tüvi on -\textit{öi}-.
\input{paradigms/rissimä}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, mille lõpuvokaal on \textit{ä}.
\input{paradigms/pähčen}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, millel puudub lõpuvokaal.
...
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu.
\input{paradigms/kompjutera}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu. % TODO kahes kohas?
\input{paradigms/čenče}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega nč:nn.
\input{paradigms/tünke}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega nk:ng.
\input{paradigms/änte}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega nt:nn.
...
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega s:z, mille mitmuse tüvi on -\textit{ii}-.
\input{paradigms/lisä}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega s:z, mille mitmuse tüvi on -\textit{äi}-.
\input{paradigms/mätä}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega t:∅.
\input{paradigms/mettse}
Sõnatüübi\-mall kirjeldab eespoolseid sõnu tüvemuutusega tts:ts.
\input{paradigms/nenä}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, mille tüvi gemineerub -\textit{nn}-.
\input{paradigms/čülä}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, mille tüvi gemineerub -\textit{ll}- \msd{sg par} vormis.
\input{paradigms/pühä}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, mille tüvi gemineerub -\textit{hh}- \msd{sg par} vormis.
\input{paradigms/üvä}
Sõnatüübi\-mall kirjeldab eespoolseid tüvemuutuseta sõnu, mille tüvi gemineerub -\textit{vv}- \msd{sg par} vormis.
\input{paradigms/kõva}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille tüvi gemineerub -\textit{vv}- \msd{sg par} vormis.
\input{paradigms/õja}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille tüvi gemineerub -\textit{jj}- \msd{sg par} vormis.
\input{paradigms/õma}
Sõnatüübi\-mall kirjeldab tagapoolseid tüvemuutuseta sõnu, mille tüvi gemineerub -\textit{mm}- \msd{sg par} vormis.
\spacing{1.5}
...
Kaheteistkümnes käändkond koondab need sõnad, mille \msd{sg nom} lõpp on \vadja{-n/-ne/-nõ}, ent mille vokaaltüves on \vadja{-se-}:\vadja{-ze-/-sö-}:\vadja{-zö-} sõltuvalt astmevaheldusele \cite[49]{ariste_grammar_1968}.
