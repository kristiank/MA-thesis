...
Integration to the selected platforms enables to get out primary tools from them and deliver them to the language community. The tools sought for in this work are a morphological analyzer/synthesizer and a spell checker.
