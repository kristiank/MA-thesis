...
Vadja õige\-kirja\-kontrollija töötab kontori\-tarkvaraga Microsoft Office, OpenOffice ja LibreOffice ning märgib punase joonega valeks kõik need sõnad, mis vormi\-sõnastikus ei sisaldu. Vadja keele õige\-kirja\-kontrollija on kätte\-saadaval internetis\footnote{\url{https://gtsvn.uit.no/langtech/trunk/langs/vot/tools/spellcheckers/}}. 
...
Peatükis~6 tutvustati magistritöö tuumosa programm\-koodi tuletamist. Programm\-koodi tuletamine toodi esile protsessina, kus vormisõnastikku kätketud teadmist kasutatakse kirjeldusena, mille põhjal kirjutatakse automaatselt programm\-koodi. Vormisõnastikku hoiti rahvusvahelise standardi \textit{Lexical Markup Framework} (LMF) vormingus ja magistritöös esitati kaks programm\-koodi\-tuletajat ehk koodi\-generaatorit. Mõlemad koodi\-generaatorid olid varustatud tõlke\-tabelitega, mistõttu  oli võimalik toetada kõigi kolme taristu terminoloogiaid ja traditsioone, nii standardi LMFi kui ka siht-taristute omi.
% lemmavabadus

Esimene koodi\-generaator integreeris vormi\-sõnastiku eri\-ots\-tarbelisesse grammatikate programmeerimis\-keelde \textit{Grammatical Framework} (GF). Selleks genereeriti vadja morfoloogia- ja leksikoni\-moodulid GFi jaoks. %Esitatud integreerimis\-viis võimaldas tööde jaotust, kus vormisõnastiku kaudu 

Teine koodi\-generaator integreeris vormi\-sõnastiku Giella taristusse, mis on seni suuremaid arendus\-keskkondi väiksemate keelte keele\-tehnoloogia arendamiseks. Taristus arendatavate keelte hulka kuulub 17 lääne\-mere soome ja saami keelt.

Vadja keele integreerimine Giella taristusse võimaldas 

Vormisõnastiku integreerimine Giella taristuga lisas taristu sihtrühma
