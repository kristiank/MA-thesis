...
% TODO
Alljärgnevates kirjeldustes on lisatud tüüpsõnade muutvormimallid kujul, kus nende tehniline tüvi on allajoonitud. Selline esitus võimaldab lugejal paremini mõista ekstrakt\-morfoloogilise muutvormimalli funktsioneerimist.
...
\input{paradigms/täi}
Tüüpsõna\-mall kirjeldab eespolseid diftongiga sõnu.
\input{paradigms/või}
Tüüpsõna\-mall kirjeldab tagapolseid diftongiga sõnu.
\spacing{1.5}
...
Tüüpsõna\-mall kirjeldab tagapoolseid tüvemuutusea sõnu.
...
Tüüpsõnamallist paradigmafunktsiooni genereerimiseks on vaja määrata funktsiooni nimi, liides (\textit{interface}) ja keha (\textit{body}). Genereeritud programm\-koodi illustreeritakse joonises~\ref{code:gf-morfoloogia}. % TODO joonis?
