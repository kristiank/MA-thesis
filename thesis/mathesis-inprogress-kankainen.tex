...
\subsubsection*{Sõnatüübid}

\spacing{1}
\input{paradigms/pihlpuu}
\input{paradigms/tüü}
\input{paradigms/pää}
\input{paradigms/täi}
\input{paradigms/või}
...
\input{paradigms/läikk}
\input{paradigms/tükkü}
\input{paradigms/viki}
\input{paradigms/fraak}
\input{paradigms/flakku}
\input{paradigms/kokki}
...
\input{paradigms/bašn̕i}
\input{paradigms/famil̕}
\spacing{1.5}
