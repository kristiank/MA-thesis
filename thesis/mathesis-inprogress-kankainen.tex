...
Tavaliselt jagatakse arvutilingvistikas morfoloogia ja fonoloogia eraldi nii, et morfoloogia tasandil on abstraktne esitus, nn morfofoneemid, mille pindesitused tulenevad fonoloogilistest reeglitest.

Näiteks jagaksid mõlemad fonoloogilised vormid \textit{tšiuttoa} ja \textit{tüttöä} sel moel sama morfoloogilise esituse käändelõpu puhul \textsc{tšiutto+a} ja \textsc{tüttö+a}. Kusjuures \textsc{+a} pindesitus \textit{a}-na või \textit{ä}-na sõltuks vastavalt sellest, kas lemmas esineb tagapoolsed või eespoolsed vokaalid.
