...
% mis on sõnatüüp? (tegelt juba pt 2.6)

% mis on eraldamine
Sõnatüübi eraldamise korral üldistab meetod lekseemi muutvormitabelit ja eraldab sellest \glslink{sõnatüübimall}{sõnatüübimalli}. Seda protsessi kirjeldatakse lähemalt pt-s~\ref{sec:ekstraktmorfoloogia-eraldamine}. % TODO eraldatud sõnatüübimallide põhjal genereeritakse programmkoodi, mida kirjeldatakse lähemalt pt-s X.
...
Ekstraktmorfoloogia meetodi ennustamisvõimet on kasutatud vaid vormisõnastiku sisestamise juures, mida kirjeldati pt-s~\ref{sec:vormisõnastiku-sisestamine}. % TODO kas seda lauset üldse jätta?
